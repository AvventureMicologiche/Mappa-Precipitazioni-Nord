...
<div class="patto">
  <p><b>A cosa serve:</b> a pianificare le tue uscite. Quanta acqua è caduta qui, giorno
  per giorno e con la data, misurata a terra da un pluviometro vero, non stimata. E <b>come</b>
  è caduta: in quante ore e con che punta, perché la stessa pioggia in un'ora o in otto non
  vale uguale.${haBoschi(REG) ? ` Che boschi ci sono intorno, tipo per tipo.` : ``} E la diretta radar, se vuoi sapere se sta piovendo adesso. Il posto esatto, poi, lo sai tu meglio di qualunque sito.</p>
