...
.card{background:var(--grigio);border:1px solid var(--bordo);border-radius:9px;padding:16px;}
...
<div class="griglia">
  <div class="card">
    ...
    <a class="cta" id="cta7" style="margin:14px 0 2px;" href="${SITO}/"
  ...
  <div class="card">
    ...
    <a class="cta" id="cta15" style="margin:14px 0 2px;" href="${SITO}/"
