...
<div class="patto">
  ...
  da pluviometri veri, posto per posto e con la data.${haBoschi(r.k) ? ` Che boschi ci sono, tipo per tipo.` : ``} Il posto esatto, poi, lo sai tu meglio di qualunque sito.</p>
